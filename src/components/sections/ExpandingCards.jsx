...
const cards = [
  {
    ...
    description:
      "Analizamos todos los aspectos que impactan en tu estrategia de ventas realizando una auditoría completa del funnel.",
    details: [
    ...
    footer:
      "Investigamos todo lo que impacta en ventas, no solo tu estrategia de medios.",
  ...
  },
  {
    ...
    description:
      "Hacemos un diagnóstico de la salud de tus ventas y priorizamos los ajustes de acuerdo a su nivel de impacto y esfuerzo.",
    details: [
      "Aumentan tu CPA",
  ...
  },
  {
    ...
    description:
      "Activamos de forma sincronizada los accionables priorizados y te acompañamos a implementar los puntos de mejora a nivel interno.",
    details: [
      "Paid Media",
      "Creatividad",
      "UX/UI",
  ...
  },
  {
    ...
    description:
      "Medimos constantemente el impacto de la ejecución en tus ventas y te brindamos feedback. Hacemos un corte y volvemos a auditar.",
...
function CardItem({ card, isOpen, onClick }) {
  return (
    ...
    >
      ...
      {/* Capas de Color */}
      <div
        className={`absolute inset-0 ${card.color} mix-blend-multiply transition-opacity duration-500 ${isOpen ? "opacity-85" : "opacity-90"}`}
      />
      <div
        className={`absolute inset-0 bg-gradient-to-t from-[#0f172a] via-[#0f172a]/50 to-transparent transition-opacity duration-500 ${isOpen ? "opacity-90" : "opacity-60"}`}
      />
